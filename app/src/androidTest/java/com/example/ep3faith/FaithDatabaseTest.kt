...
import com.example.ep3faith.database.Youngster
...
class FaithDatabaseTest {
    ...
    fun insertAndGetYoungster(){
        val youngster = Youngster()
        youngster.username = "Nicerdicer"
        faithDAO.insertYoungster(youngster)
        Timber.i(youngster.youngsterId.toString())
